...
// "page area" that is used to display pages related to each tab.

// All classes that contain signals or slots must mention Q_OBJECT at the
// top of their declaration. They must also derive (directly or indirectly) from QObject.
...
signals:
    ...
    // implemented in the .cpp file. They can never have return types (i.e. use void).
    void tabDragRequested(int index);
